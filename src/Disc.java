...
//Basic info:
//All algorithms have priority handling using EDF, except FD_SCAN
...
public class Disc {
    ...
    //updates after every move of head (only 1 unit at a time in current direction), executes all processes on current sector, then moves and updates
    //head move pattern: right, back to left edge skipping requests on the way (costs only 1 movement), right...
